...
function Bio () {
  return (
    <div>
      ...
      <p>I have a wide skillset and focus on iterative development and the appropriate application of technology. I’m a self-taught developer with the amazing non-profit, freeCodeCamp.</p>
    </div>
  )
}
